...
export const BRAND_CSS_VARS = {
  primary: `var(${CSS_VAR_PRIMARY}, var(--wb-p-500, #3d6df2))`,
  primaryHover: `var(${CSS_VAR_PRIMARY_HOVER}, var(--wb-p-600, #2b55d4))`,
  accent: `var(${CSS_VAR_ACCENT}, var(--wb-p-500, #3d6df2))`,
